...
def generate_recommendation(
    ...
    if existing_recommendation:
        ...
        return build_recommendation_response(existing_recommendation, product.name)
...
def generate_recommendations_for_all_products(
    ...
    for product in products:
        ...
        if existing_recommendation:
            existing_recommendation.recommended_quantity = recommended_quantity
            existing_recommendation.reason = reason
            recommendations.append((existing_recommendation, product.name))
        else:
            db_recommendation = Recommendation(
                user_id=current_user.id,
            ...
            db.add(db_recommendation)
            recommendations.append((db_recommendation, product.name))

    db.commit()

    responses = []

    for recommendation, product_name in recommendations:
